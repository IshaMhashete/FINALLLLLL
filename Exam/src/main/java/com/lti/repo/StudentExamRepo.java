...
public class StudentExamRepo {
	...
	@Transactional
	public void AddResumestudentreport(int reportid, int count1, int count2, int count3) {
		StudentSideReport studentsideReport = entityManager.find(StudentSideReport.class, reportid);
		studentsideReport.setLevel1score(count1);
		studentsideReport.setLevel2score(count2);
		studentsideReport.setLevel3score(count3);
		entityManager.merge(studentsideReport);
