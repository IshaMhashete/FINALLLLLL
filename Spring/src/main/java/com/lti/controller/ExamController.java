...
//*************************************************************************************************	
	...
	//**********************************************************************************************************************
	@RequestMapping(path="/subjectAdd.lti")
	public String subjectAdd(Subject subject,ModelMap model) {
		examService.subjectadd(subject);
		return "redirect:adminDashboard.lti";
	} 
//*************************************************************************************************************************	
	@RequestMapping(path="/listSubject.lti")
		public String listSubject(ModelMap model) {
		 List<Subject> list=examService.listsubject();
		 model.put("subjectlist", list);
			return "SubjectChoice.jsp";
		}
	
	@RequestMapping(path="/listSubjectadminside.lti")
	public String listSubjectadminside(ModelMap model) {
	 List<Subject> list=examService.listsubject();
	 model.put("subjectlist", list);
		return "viewQuestionSubjectChoice.jsp";
	}
	
	@RequestMapping(path="/listSubjectstudentside.lti")
	public String listSubjectstudentside(ModelMap model) {
	 List<Subject> list=examService.listsubject();
	 model.put("subjectlist", list);
		return "studentSubjectChoice.jsp";
	}
	
	@RequestMapping(path="/listviewSubjectstudentside.lti")
	public String listviewSubjectstudentside(ModelMap model) {
	 List<Subject> list=examService.listsubject();
	 model.put("subjectlist", list);
